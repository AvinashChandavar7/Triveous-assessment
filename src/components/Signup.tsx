      ...
      <div className={`mx-auto w-full max-w-lg bg-purple-900 rounded-xl p-10`}>
        ...
        <form onSubmit={createSignUp} className="mt-8">
          <div className="space-y-5">
            ...
            <div>
              <button type="submit" className="inline-flex w-full items-center justify-center rounded-md bg-primary  font-semibold leading-7 text-white  hover:bg-primary/80  py-2" >
                Create Account
              </button>
            </div>
          </div>
